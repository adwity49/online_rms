<?php include "include/header.php" ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $select = "SELECT * FROM orders_details WHERE orders_status = 0";
                ...
                if ($select_result) {
                   ...
                   $orddr_upquery = "UPDATE orders_details SET orders_status = 1";
                  $orddr_upquery_result = $db->update($orddr_upquery);

                  while($row = mysqli_fetch_assoc($orddr_upquery)){
