        ...
        <div class="col-md-12">
                ...
                <?php 
                   ...
                   if (isset($_GET['itm_id'])) {
                        ...
                        <div class="row">
                             <div class="col-md-3">
                                 <img height="400px" width="300px" src="images/item_img/<?php echo $item_img; ?>" alt="">
                             </div>
                            ...
                            <div class="col-md-3">
                             <div class="" style="margin-left: 30px;">
                                <form action="confirm_order.php" method="post">
                                 ...
                                 <div class="form-group">
                                   <label class="" for="">Total Item</label>
                                  <input type="text" name="item_total" class="form-control">
                                 </div>
                                 ...
                                 <input type="hidden" name="itemprice" value="<?php echo $item_price; ?>">
                                  ...
                                  if(Session::get('userlogin')==true){ ?>
                                     ...
                                     <div class="form-group">
                                   <input type="submit" name="submit_info" class="btn btn-primary" value="Process Order">
                                 </div>

                                 <?php }else{

                                    echo "<p style='color:red;'>You have to login for order</p>";
                                  }
                             ...
                             <div class="" style="margin-left: 30px;">
                                <form action="confirm_order.php" method="post">
                                 ...
                                 <?php }else{
                                    ...
                                    echo "you have to login for order";
                                  }
